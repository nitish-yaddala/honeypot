  ...
  return (function (e) {
      ...
      (u.prototype = {
        ...
        getFonts: function () {
          for (
            ...
            r.detect(e[t]) && (i += t == e.length - 1 ? e[t] : e[t] + ", ");
          return i;
        },
    ...
    function (e, i, t) {
       ...
       */ !(function (r, o) {
        ...
        var a = "function",
          ...
          S = {
            rgx: function (e, i) {
              for (var t, n, r, s, u, c, d = 0; d < i.length && !u; ) {
                var p = i[d],
                  f = i[d + 1];
                for (t = n = 0; t < p.length && !u; )
                  if ((u = p[t++].exec(e)))
              ...
              for (var t in i)
                if (typeof i[t] === l && i[t].length > 0) {
                  for (var n = 0; n < i[t].length; n++)
                    if (y.has(i[t][n], e)) return "?" === t ? o : t;
                } else if (y.has(i[t], e)) return "?" === t ? o : t;
              return e;
            },
          },
          T = {
          ...
          C = {
            browser: [
              ...
              [[c, "Yandex"], f],
              [/(Avast)\/([\w\.]+)/i],
              [[c, "Avast Secure Browser"], f],
              [/(AVG)\/([\w\.]+)/i],
              [[c, "AVG Secure Browser"], f],
              [/(puffin)\/([\w\.]+)/i],
              [[c, "Puffin"], f],
              [/(focus)\/([\w\.]+)/i],
              [[c, "Firefox Focus"], f],
              ...
              [c, [f, S.str, T.browser.oldsafari.version]],
              [/(webkit|khtml)\/([\w\.]+)/i],
              [c, f],
            ...
            device: [
              ...
              [/(sprint\s(\w+))/i],
              [
                [p, S.str, T.device.sprint.vendor],
                [u, S.str, T.device.sprint.model],
                [d, g],
              ],
              [
            ...
            os: [
              ...
              [c, [f, S.str, T.os.windows.version]],
              [/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
              [
                [c, "Windows"],
                [f, S.str, T.os.windows.version],
              ],
              [/\((bb)(10);/i],
              [[c, "BlackBerry"], f],
              [
          ...
          x = function (e, i) {
            if (
              ("object" == typeof e && ((i = e), (e = o)), !(this instanceof x))
            )
              return new x(e, i).getResult();
            var t =
                e ||
            ...
            return (
              (this.getBrowser = function () {
                ...
                return (
                  S.rgx.call(e, t, n.browser), (e.major = y.major(e.version)), e
                );
              }),
              (this.getCPU = function () {
                var e = { architecture: o };
                return S.rgx.call(e, t, n.cpu), e;
              }),
              (this.getDevice = function () {
                var e = { vendor: o, model: o, type: o };
                return S.rgx.call(e, t, n.device), e;
              }),
              (this.getEngine = function () {
                var e = { name: o, version: o };
                return S.rgx.call(e, t, n.engine), e;
              }),
              (this.getOS = function () {
                var e = { name: o, version: o };
                return S.rgx.call(e, t, n.os), e;
              }),
        ...
        (x.VERSION = "0.7.22"),
          (x.BROWSER = { NAME: c, MAJOR: "major", VERSION: f }),
          ...
          (x.ENGINE = { NAME: c, VERSION: f }),
          (x.OS = { NAME: c, VERSION: f }),
          typeof i !== s
            ? (typeof e !== s && e.exports && (i = e.exports = x),
              (i.UAParser = x))
            : (n = function () {
                return x;
              }.call(i, t, i, e)) === o || (e.exports = n);
        var A = r && (r.jQuery || r.Zepto);
        if (A && !A.ua) {
          var E = new x();
          (A.ua = E.getResult()),
            (A.ua.get = function () {
      ...
      e.exports = function () {
        ...
        for (var o in e)
          (t.style.fontFamily = e[o]),
            i.appendChild(t),
            (n[e[o]] = t.offsetWidth),
            (r[e[o]] = t.offsetHeight),
            i.removeChild(t);
        this.detect = function (o) {
          var a = !1;
          for (var s in e) {
            (t.style.fontFamily = o + "," + e[s]), i.appendChild(t);
            var l = t.offsetWidth != n[e[s]] || t.offsetHeight != r[e[s]];
    ...
    function (e, i, t) {
      ...
      function u(e, i) {
        ...
        if (null != n) {
          if (i) return !0;
          for (var r = !1, a = !1, s = new Array(), u = 1; u < n.length; ++u)
            "string" == typeof n[u] && "" != n[u] && ((s[t] = n[u]), t++);
          "+" == s[s.length - 1]
            ? ((a = !0), (r = !1), s.length--)
            : "*" == s[s.length - 1]
            ? ((a = !1), (r = !0), s.length--)
          ...
          for (var c = f.getJREs(), d = 0; d < c.length; ++d)
            if (f.compareVersionToPattern(c[d], s, r, a)) return !0;
          return !1;
        }
        ...
        document.location =
          ...
          (function (e) {
            ...
            if (
              (function (e) {
                for (
                  var i = ["http://", "https://", "file://"], t = 0;
                  t < i.length;
                  t++
                )
                  if (e.toLowerCase().startsWith(i[t])) return !0;
                return !1;
              })(e)
            )
              i = e;
      ...
      function p(e) {
        var i = "https://java.com/dt-redirect";
        return null == e || 0 == e.length
          ? i
          : ("&" == e.charAt(0) && (e = e.substring(1, e.length)), i + "?" + e);
      }
      "function" != typeof String.prototype.startsWith &&
        (String.prototype.startsWith = function (e, i) {
      ...
      var f = {
        ...
        getJREs: function () {
          ...
          if (this.isPluginInstalled())
            for (var i = this.getPlugin().jvms, t = 0; t < i.getLength(); t++)
              e[t] = i.get(t).version;
          else {
        ...
        installLatestJRE: function () {
          if (
            ...
            return "MSIE" == e
              ? this.IEInstall()
              : "Netscape Family" == e && -1 != i.indexOf("win32")
              ? this.FFInstall()
              : ((location.href = p(
        ...
        runApplet: function (e, i, t) {
          if (
            (("undefined" != t && null != t) || (t = "1.1"), null != t.match(r))
          )
            if ("?" != this.getBrowser()) {
              if (d()) {
              ...
              (this.versionCheck(t + "+") || this.installJRE(t + "+")) &&
                this.writeAppletTag(e, i);
            } else this.writeAppletTag(e, i);
          else
            l(
        ...
        writeAppletTag: function (e, i) {
          var t = "<applet ",
            n = "",
            r = !0;
          for (var o in ((null != i && "object" == typeof i) ||
            (i = new Object()),
          e))
            (function (e, i) {
        ...
        getJPIVersionUsingMimeType: function () {
          ...
          for (e = 0; e < navigator.mimeTypes.length; ++e)
            if (
              null !=
              (i = navigator.mimeTypes[e].type.match(
          ...
          for (e = 0; e < navigator.mimeTypes.length; ++e)
            null !=
              ...
              (null == this.firefoxJavaVersion ||
                this.compareVersions(i[1], this.firefoxJavaVersion)) &&
              (this.firefoxJavaVersion = i[1]);
        },
        launchWebStartApplication: function (e) {
          if ((this.getJPIVersionUsingMimeType(), 0 == u("1.7.0+", !1)))
            if (d()) c(e);
              ...
              return !1;
          var i = null;
          document.documentURI && (i = document.documentURI),
            null == i && (i = document.URL);
          var t,
            n = this.getBrowser();
          if (
            ("MSIE" == n
            ...
            document.write(t), (document.location = i);
          else {
        ...
        compareVersionToPattern: function (e, i, t, n) {
          if (e == undefined || i == undefined) return !1;
          var o = e.match(r);
          if (null != o) {
            for (var a = 0, s = new Array(), l = 1; l < o.length; ++l)
              "string" == typeof o[l] && "" != o[l] && ((s[a] = o[l]), a++);
            var u = Math.min(s.length, i.length);
            if (n) {
              for (var c = 0; c < u; ++c) {
                var d = parseInt(s[c]),
                  p = parseInt(i[c]);
            ...
            for (var f = 0; f < u; ++f) if (s[f] != i[f]) return !1;
            return !!t || s.length == i.length;
          }
          return !1;
        },
        getBrowser: function () {
        ...
        testUsingActiveX: function (e) {
          var i = "JavaWebStart.isInstalled." + e + ".0";
        ...
        testUsingMimeTypes: function (e) {
          ...
          for (var i = 0; i < navigator.mimeTypes.length; ++i) {
            var t = navigator.mimeTypes[i].type.match(
              /^application\/x-java-applet\x3Bversion=(1\.8|1\.7|1\.6|1\.5|1\.4\.2)$/
            );
            if (null != t && this.compareVersions(t[1], e)) return !0;
          }
          return !1;
        },
        testUsingPluginsArray: function (e) {
          ...
          for (
            var i = navigator.platform.toLowerCase(), t = 0;
        ...
        compareVersions: function (e, i) {
          for (var t = e.split("."), n = i.split("."), r = 0; r < t.length; ++r)
            t[r] = Number(t[r]);
          for (var o = 0; o < n.length; ++o) n[o] = Number(n[o]);
          return (
            2 == t.length && (t[2] = 0),
            t[0] > n[0] ||
              (!(t[0] < n[0]) &&
                (t[1] > n[1] ||
                  (!(t[1] < n[1]) && (t[2] > n[2] || !(t[2] < n[2])))))
          );
        },
        ...
        writeEmbedTag: function () {
          ...
          if (null != navigator.mimeTypes) {
            for (var i = 0; i < navigator.mimeTypes.length; i++)
              navigator.mimeTypes[i].type == this.mimeType &&
...
*/
      var t,
        ...
        E = (function () {
          var e =
            ...
            t = g.platform.toLowerCase(),
            n = /win/.test(t || i),
            r = /mac/.test(t || i),
            o =
              !!/webkit/.test(i) &&
              parseFloat(i.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")),
          ...
          if (typeof g.plugins !== l && typeof g.plugins[c] === u)
            ...
            try {
              ...
              f &&
                ...
                ((a = !0),
                (s = [
                  G((p = p.split(" ")[1].split(","))[0]),
                  G(p[1]),
                  G(p[2]),
                ]));
            } catch (w) {}
          return { w3: e, pv: s, wk: o, ie: a, win: n, mac: r };
        })();
      function M() {
        if (!T && document.getElementsByTagName("body")[0]) {
          try {
            ...
            (i.style.display = "none"),
              (e = m
                ...
                .appendChild(i)).parentNode.removeChild(e),
              (e = null),
              (i = null);
          } catch (r) {
            return;
          ...
          T = !0;
          for (var t = w.length, n = 0; n < t; n++) w[n]();
        }
      }
      function k(e) {
        T ? e() : (w[w.length] = e);
        ...
        if (e > 0)
          for (var i = 0; i < e; i++) {
            ...
            if (E.pv[0] > 0) {
              var o = D(t);
              if (o)
                if (!_(b[i].swfVersion) || (E.wk && E.wk < 312))
                  if (b[i].expressInstall && I()) {
                    var a = {};
                    (a.data = b[i].expressInstall),
                      (a.width = o.getAttribute("width") || "0"),
                      (a.height = o.getAttribute("height") || "0"),
                      o.getAttribute("class") &&
                        (a.styleclass = o.getAttribute("class")),
                      o.getAttribute("align") &&
                        (a.align = o.getAttribute("align"));
                    for (
                      var s = {},
                        u = o.getElementsByTagName("param"),
                        c = u.length,
                        d = 0;
                      d < c;
                      d++
                  ...
                  z(t, !0),
                    n && ((r.success = !0), (r.ref = N(t)), (r.id = t), n(r));
            } else if ((z(t, !0), n)) {
              var p = N(t);
              p &&
      ...
      function N(e) {
        ...
        return (
          t &&
            ...
            (i =
              typeof t.SetVariable !== l
                ? t
                : t.getElementsByTagName(u)[0] || t),
          i
        );
      }
      function I() {
        return !C && _("6.0.65") && (E.win || E.mac) && !(E.wk && E.wk < 312);
      }
      function B(e, i, a, s) {
        var u = D(a);
        if (
          ...
          "OBJECT" === u.nodeName.toUpperCase()
            ...
            (e.id = p),
            (typeof e.width === l ||
              (!/%$/.test(e.width) && G(e.width) < 310)) &&
              (e.width = "310"),
            (typeof e.height === l ||
              (!/%$/.test(e.height) && G(e.height) < 137)) &&
              (e.height = "137");
          var c = E.ie ? "ActiveX" : "PlugIn",
            d =
              "MMredirectURL=" +
      ...
      function L(e) {
        if (E.ie && 4 != e.readyState) {
          e.style.display = "none";
          var i = J("div");
          e.parentNode.insertBefore(i, e),
            i.parentNode.replaceChild(j(e), i),
            R(e);
        } else e.parentNode.replaceChild(j(e), e);
      }
      function j(e) {
        var i = J("div");
        if (E.win && E.ie) i.innerHTML = e.innerHTML;
        else {
          ...
          if (t) {
            ...
            if (n)
              for (var r = n.length, o = 0; o < r; o++)
                (1 == n[o].nodeType && "PARAM" === n[o].nodeName) ||
                  8 == n[o].nodeType ||
                  i.appendChild(n[o].cloneNode(!0));
          }
        }
        return i;
      }
      function U(e, i, t) {
        var n,
          ...
          a,
          s = D(t);
        if (((t = V(t)), E.wk && E.wk < 312)) return n;
        if (s) {
          var c,
            p,
            f,
            h = E.ie ? J("div") : J(u);
          for (f in (typeof e.id === l && (e.id = t), i))
      ...
      function O(e, i, t) {
        var n = J("param");
        n.setAttribute("name", i), n.setAttribute("value", t), e.appendChild(n);
      }
      function R(e) {
        var i = D(e);
        i &&
          ...
          (E.ie
            ? ((i.style.display = "none"),
              (function t() {
                if (4 == i.readyState) {
                  for (var e in i) "function" == typeof i[e] && (i[e] = null);
      ...
      function W(e, i, t, n) {
        ...
        if (r) {
          var o = "string" == typeof t ? t : "screen";
          if ((n && ((a = null), (s = null)), !a || s != o)) {
            var u = J("style");
            u.setAttribute("type", "text/css"),
              ...
              E.ie &&
                ...
                (a = m.styleSheets[m.styleSheets.length - 1]),
              (s = o);
          }
          a &&
            (typeof a.addRule !== l
              ...
              : typeof m.createTextNode !== l &&
                a.appendChild(m.createTextNode(e + " {" + i + "}")));
        }
      }
      function z(e, i) {
        if (x) {
          ...
          T && n
            ...
            : "string" == typeof e && W("#" + e, "visibility:" + t);
        }
      }
      function H(e) {
        ...
        T ||
          ...
          E.ie &&
            (m.attachEvent(f, function X() {
              "complete" === m.readyState && (m.detachEvent(f, X), M());
            }),
            h == top &&
              (function $() {
                if (!T) {
          ...
          E.wk &&
            (function K() {
              T ||
                (/loaded|complete/.test(m.readyState) ? M() : setTimeout(K, 0));
            })())),
        (w[0] = function () {
          v
            ? (function () {
                ...
                if (t) {
                  var n = 0;
                  !(function r() {
                    if (typeof t.GetVariable !== l)
                      try {
                        var o = t.GetVariable("$version");
                        o &&
                          ((o = o.split(" ")[1].split(",")),
                          (E.pv = [G(o[0]), G(o[1]), G(o[2])]));
                      } catch (a) {
                        E.pv = [8, 0, 0];
                      }
                    else if (n < 10) return n++, void setTimeout(r, 10);
                    e.removeChild(i), (t = null), P();
                  })();
                } else P();
              })()
            : P();
        ...
        E.ie &&
          window.attachEvent("onunload", function () {
            for (var e = S.length, i = 0; i < e; i++)
              S[i][0].detachEvent(S[i][1], S[i][2]);
            for (var t = y.length, n = 0; n < t; n++) R(y[n]);
            for (var r in E) E[r] = null;
            for (var o in ((E = null), q)) q[o] = null;
            q = null;
          });
      var q = {
        ...
        embedSWF: function (e, i, t, n, r, o, a, s, c, d) {
          var p = V(i),
            f = { success: !1, id: p };
          E.w3 && !(E.wk && E.wk < 312) && e && i && t && n && r
            ? (z(p, !1),
              k(function () {
                (t += ""), (n += "");
                var h = {};
                if (c && typeof c === u) for (var m in c) h[m] = c[m];
                (h.data = e), (h.width = t), (h.height = n);
                var g = {};
                if (s && typeof s === u) for (var v in s) g[v] = s[v];
                if (a && typeof a === u)
                  for (var w in a)
                    if (Object.prototype.hasOwnProperty.call(a, w)) {
                      var b = A ? encodeURIComponent(w) : w,
                        y = A ? encodeURIComponent(a[w]) : a[w];
                ...
                if (_(r)) {
                  ...
                  if (o && I()) return (h.data = o), void B(h, g, i, d);
                  z(p, !0);
                }
                d && d(f);
              }))
        ...
        addLoadEvent: function (e) {
          if (typeof h.addEventListener !== l)
            ...
            !(function (e, i, t) {
              e.attachEvent(i, t), (S[S.length] = [e, i, t]);
            })(h, "onload", e);
        ...
        getQueryParamValue: function (e) {
          var i = m.location.search || m.location.hash;
          if (i) {
            if ((/\?/.test(i) && (i = i.split("?")[1]), !e)) return H(i);
            for (var t = i.split("&"), n = 0; n < t.length; n++)
              if (t[n].substring(0, t[n].indexOf("=")) == e)
                return H(t[n].substring(t[n].indexOf("=") + 1));
          }
          return "";
        },
        expressInstallCallback: function () {
          if (C) {
            ...
            e &&
              ...
              n && (z(n, !0), E.ie && (t.style.display = "block")),
              r && r(o)),
              (C = !1);
          }
        },
    ...
    function (e, i, t) {
      ...
      n(s, r),
        (s.prototype.getJavaVersion = o),
        (s.prototype.getFlashVersion = a),
        (i.ClientJS = s);
    },
  ]);
});
